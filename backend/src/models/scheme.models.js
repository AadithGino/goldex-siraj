...
const schemeSchema = new Schema({
  ...
  benefitType: { type: String, enum: ['bonus_months', 'fixed_amount'], default: 'bonus_months' },
  benefitFixedAmount: { type: Number, min: 0, default: 0 },
...
const enrollmentSchema = new Schema({
  ...
  benefitTypeSnapshot: { type: String, enum: ['bonus_months', 'fixed_amount'], default: 'bonus_months' },
  benefitFixedAmountSnapshot: { type: Number, min: 0, default: 0 },
