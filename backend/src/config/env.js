...
export const config = Object.freeze({
  ...
  storage: { driver: env.STORAGE_DRIVER, localPath: env.STORAGE_LOCAL_PATH, publicUrl: env.STORAGE_PUBLIC_URL, maxBytes: env.MAX_UPLOAD_BYTES, s3: { region: env.S3_REGION, bucket: env.S3_BUCKET, endpoint: env.S3_ENDPOINT, accessKeyId: env.S3_ACCESS_KEY_ID, secretAccessKey: env.S3_SECRET_ACCESS_KEY } },
