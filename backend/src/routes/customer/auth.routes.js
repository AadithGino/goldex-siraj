...
import { profileSchema, refreshSessionSchema, sendOtpSchema, verifyOtpSchema } from '../../validators/auth.validators.js'
...
router.post('/refresh', validate(refreshSessionSchema), asyncHandler(controller.refresh))
