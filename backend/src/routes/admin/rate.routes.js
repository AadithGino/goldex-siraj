...
router.get('/gold-buyback', asyncHandler(controller.goldBuybackList))
router.post('/gold-buyback', authorizeStaffRoles('manager'), validate(goldRateSchema), asyncHandler(controller.goldBuybackSet))
