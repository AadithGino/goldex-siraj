...
export async function sendOtp(req, res) { ok(res, await authService.sendOtp(req.validated.body.phone), 202) }
export async function verifyOtp(req, res) {
  ...
  ok(res, { user: serialize(customer), access_token: tokens.accessToken }, 200)
}
